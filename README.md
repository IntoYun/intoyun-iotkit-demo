...
复制`src/intoyun-iotkit-sdk/examples/smartLight/destop/`到`src/apps/`中。
...
复制`src/intoyun-iotkit-sdk/examples/smartLight/esp8266/`到`src/apps/`中。
...
复制`src/intoyun-iotkit-sdk/examples/smartLight/esp32/`到`src/apps/`中。
